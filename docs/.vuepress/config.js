...
module.exports = {
    ...
    head: [
        [
            ...
            hm.src = "https://hm.baidu.com/hm.js?29806794da4eeee331918ce3d1591cc3";
        ...
        extendMarkdown: md => {
            md.use(function(md) {
                ...
                md.renderer.rules.fence = (...args) => {
                    ...
                    // rawCode = rawCode.replace(`<span class="token comment">1</span>`,'<a href="$1" class="try-button" target="_blank">Try</a>');
